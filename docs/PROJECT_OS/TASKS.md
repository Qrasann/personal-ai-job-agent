...
### TASK-004: Экспорт сохраненных вакансий [COMPLETED]
- **Goal:** Реализована команда `/export` (и `/export json`) для скачивания файла со всеми `/saved` вакансиями, баллами, описаниями и ссылками.
- **Status:** COMPLETED
